...
const Header: React.FC<MyComponentsProps> = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <nav className='font-platypi font-light flex flex-row justify-between md:justify-evenly text-[14px] md:text-[17px] h-fit w-full px-4 lg:py-6 py-4'>
      ...
      <button onClick={setMode} className={generateClassNames(headerIcon)}>
